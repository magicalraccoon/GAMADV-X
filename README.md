...
-rw-r-----+ 1 admin  staff  2377 Mar  3 09:23 oauth2service.json
```
Update your project to include the additional APIs that GAMADV-X uses.
```
admin@server:/usr/local/gamadv-x$  gam update project
...
GAM 4.48.46 - https://github.com/taers232c/GAMADV-X
