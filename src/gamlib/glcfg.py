...
# Include repeating item count columns in CSV output file
CSV_OUTPUT_ITEM_COUNT_COLUMNS = u'csv_output_item_count_columns'
...
Defaults = {
  ...
  CSV_OUTPUT_ITEM_COUNT_COLUMNS: TRUE,
...
VAR_INFO = {
  ...
  CSV_OUTPUT_ITEM_COUNT_COLUMNS: {VAR_TYPE: TYPE_BOOLEAN, VAR_ENVVAR: u'GAM_CSV_OUTPUT_ITEM_COUNT_COLUMNS'},
