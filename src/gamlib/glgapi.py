...
GROUP_GET_THROW_REASONS = [GROUP_NOT_FOUND, DOMAIN_NOT_FOUND, FORBIDDEN, BAD_REQUEST]
GROUP_SETTINGS_THROW_REASONS = [GROUP_NOT_FOUND, DOMAIN_NOT_FOUND, FORBIDDEN, SYSTEM_ERROR]
GROUP_SETTINGS_RETRY_REASONS = [INVALID, SERVICE_LIMIT]
MEMBERS_THROW_REASONS = [GROUP_NOT_FOUND, DOMAIN_NOT_FOUND, INVALID, FORBIDDEN]
MEMBERS_RETRY_REASONS = [SYSTEM_ERROR]
USER_GET_THROW_REASONS = [USER_NOT_FOUND, DOMAIN_NOT_FOUND, FORBIDDEN, BAD_REQUEST, SYSTEM_ERROR]
